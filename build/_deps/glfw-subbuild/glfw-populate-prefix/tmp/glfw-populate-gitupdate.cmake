...
execute_process(
  COMMAND "D:/git/Git/cmd/git.exe" --git-dir=.git show-ref "3.3.8"
  WORKING_DIRECTORY "E:/opengl/iMc/build/_deps/glfw-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/opengl/iMc/build/_deps/glfw-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/opengl/iMc/build/_deps/glfw-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "D:/git/Git/cmd/git.exe" --git-dir=.git submodule update --recursive --init 
    WORKING_DIRECTORY "E:/opengl/iMc/build/_deps/glfw-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
